    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          <div className="rounded-lg border border-border bg-card/50 p-8 text-center backdrop-blur-sm">
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-lg border border-border bg-card/50 p-8 backdrop-blur-sm">
          ...
          <p className="mb-8 text-sm text-muted-foreground">Join PayEase and start settling crypto payments</p>
